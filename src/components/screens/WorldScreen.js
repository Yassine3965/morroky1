...
export default class WorldScreen {
  ...
  async fetchMerchants() {
    // --- TEST CODE START ---
    console.log("Using fake merchant data for testing.");
    // Simulate a network delay
    await new Promise(resolve => setTimeout(resolve, 1500)); 

    const fakeMerchants = [
      { id: \'fake1\', name: \'متجر اختباري ١\', status: \'verified\', rating: 5, successful_sales: 100, unsuccessful_sales: 1, location: { city: \'Casablanca\', street: \'Test Street 1\' } },
      { id: \'fake2\', name: \'متجر وهمي ٢\', status: \'verified\', rating: 4, successful_sales: 50, unsuccessful_sales: 5, location: { city: \'Casablanca\', street: \'Test Street 2\' } },
      { id: \'fake3\', name: \'متجر مؤقت ٣\', status: \'verified\', rating: 4.5, successful_sales: 200, unsuccessful_sales: 2, location: { city: \'Casablanca\', street: \'Test Street 3\' } },
    ];

    this.state = { ...this.state, merchants: fakeMerchants, loading: false };
    console.log("Fake data loaded:", this.state.merchants);
    // --- TEST CODE END ---
